...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Text_Eingabe.setGeometry(QtCore.QRect(560, 60, 181, 31))
        self.Text_Eingabe.setObjectName("Text_Eingabe")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(560, 30, 141, 20))
        ...
        self.Text_Eingabe_2.setGeometry(QtCore.QRect(560, 140, 181, 31))
        self.Text_Eingabe_2.setObjectName("Text_Eingabe_2")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(560, 110, 141, 20))
        self.label_8.setObjectName("label_8")
        self.checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox.setGeometry(QtCore.QRect(760, 140, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.checkBox.setFont(font)
        self.checkBox.setObjectName("checkBox")
        self.checkBox_2 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_2.setGeometry(QtCore.QRect(760, 60, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.Clear_Button.setGeometry(QtCore.QRect(960, 370, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.Clear_Button.setFont(font)
        self.Clear_Button.setObjectName("Clear_Button")
        self.Text_Eingabe_3 = QtWidgets.QLineEdit(self.centralwidget)
        self.Text_Eingabe_3.setGeometry(QtCore.QRect(560, 210, 51, 31))
        self.Text_Eingabe_3.setObjectName("Text_Eingabe_3")
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(560, 180, 61, 20))
        self.label_10.setObjectName("label_10")
        self.Text_Eingabe_4 = QtWidgets.QLineEdit(self.centralwidget)
        self.Text_Eingabe_4.setGeometry(QtCore.QRect(630, 210, 51, 31))
        self.Text_Eingabe_4.setObjectName("Text_Eingabe_4")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(630, 180, 61, 20))
        self.label_11.setObjectName("label_11")
        self.MplWidget = MplWidget(self.centralwidget)
        self.MplWidget.setGeometry(QtCore.QRect(10, 500, 450, 350))
        self.MplWidget.setObjectName("MplWidget")
        self.MplWidget_2 = MplWidget(self.centralwidget)
        self.MplWidget_2.setGeometry(QtCore.QRect(480, 500, 450, 350))
        self.MplWidget_2.setObjectName("MplWidget_2")
        self.Text_Eingabe_5 = QtWidgets.QLineEdit(self.centralwidget)
        self.Text_Eingabe_5.setGeometry(QtCore.QRect(700, 210, 51, 31))
        self.Text_Eingabe_5.setObjectName("Text_Eingabe_5")
        self.label_12 = QtWidgets.QLabel(self.centralwidget)
        self.label_12.setGeometry(QtCore.QRect(700, 180, 101, 16))
