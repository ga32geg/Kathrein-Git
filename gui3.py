...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(952, 897)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.textBrowser = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(10, 300, 921, 221))
        ...
        self.spinBox_nSelection.setGeometry(QtCore.QRect(130, 170, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.spinBox_ID.setGeometry(QtCore.QRect(30, 170, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.spinBox_ID.setFont(font)
        self.spinBox_ID.setMinimum(1)
        self.spinBox_ID.setMaximum(64)
        ...
        self.spinBox_Time.setGeometry(QtCore.QRect(240, 170, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_4.setGeometry(QtCore.QRect(220, 140, 91, 20))
        self.label_4.setObjectName("label_4")
        self.Text_Eingabe = QtWidgets.QLineEdit(self.centralwidget)
        self.Text_Eingabe.setGeometry(QtCore.QRect(520, 90, 191, 31))
        self.Text_Eingabe.setObjectName("Text_Eingabe")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(520, 50, 141, 20))
        ...
        self.Text_Eingabe_2.setGeometry(QtCore.QRect(520, 170, 191, 31))
        self.Text_Eingabe_2.setObjectName("Text_Eingabe_2")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(520, 140, 141, 20))
        self.label_8.setObjectName("label_8")
        self.checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox.setGeometry(QtCore.QRect(750, 160, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.checkBox.setFont(font)
        self.checkBox.setObjectName("checkBox")
        self.checkBox_2 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_2.setGeometry(QtCore.QRect(750, 80, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.checkBox_2.setFont(font)
        self.checkBox_2.setObjectName("checkBox_2")
        self.graphWidget = PlotWidget(self.centralwidget)
        self.graphWidget.setGeometry(QtCore.QRect(10, 880, 921, 211))
        ...
        self.spinBox_Leistung_dBm.setGeometry(QtCore.QRect(350, 170, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_9.setGeometry(QtCore.QRect(330, 140, 121, 21))
        self.label_9.setObjectName("label_9")
        self.Clear_Button = QtWidgets.QPushButton(self.centralwidget)
        self.Clear_Button.setGeometry(QtCore.QRect(840, 470, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.Clear_Button.setFont(font)
        self.Clear_Button.setObjectName("Clear_Button")
        self.Text_Eingabe_3 = QtWidgets.QLineEdit(self.centralwidget)
        self.Text_Eingabe_3.setGeometry(QtCore.QRect(520, 240, 51, 31))
        self.Text_Eingabe_3.setObjectName("Text_Eingabe_3")
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(520, 210, 61, 20))
        self.label_10.setObjectName("label_10")
        self.Text_Eingabe_4 = QtWidgets.QLineEdit(self.centralwidget)
        self.Text_Eingabe_4.setGeometry(QtCore.QRect(590, 240, 51, 31))
        self.Text_Eingabe_4.setObjectName("Text_Eingabe_4")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(590, 210, 61, 20))
        self.label_11.setObjectName("label_11")
        self.Text_Eingabe_5 = QtWidgets.QLineEdit(self.centralwidget)
        self.Text_Eingabe_5.setGeometry(QtCore.QRect(660, 240, 51, 31))
        self.Text_Eingabe_5.setObjectName("Text_Eingabe_5")
        self.label_12 = QtWidgets.QLabel(self.centralwidget)
        self.label_12.setGeometry(QtCore.QRect(660, 210, 101, 16))
        self.label_12.setObjectName("label_12")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(10, 0, 451, 291))
        ...
        self.Start_Button.setGeometry(QtCore.QRect(150, 230, 165, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.Start_Button.setFont(font)
        self.Start_Button.setObjectName("Start_Button")
        self.checkBox_3 = QtWidgets.QCheckBox(self.frame)
        self.checkBox_3.setGeometry(QtCore.QRect(20, 240, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.frame_2.setGeometry(QtCore.QRect(480, 0, 451, 291))
        self.frame_2.setFrameShape(QtWidgets.QFrame.Box)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setLineWidth(3)
        self.frame_2.setObjectName("frame_2")
        self.Plot_Button = QtWidgets.QPushButton(self.frame_2)
        self.Plot_Button.setGeometry(QtCore.QRect(270, 230, 165, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.Plot_Button.setFont(font)
        self.Plot_Button.setObjectName("Plot_Button")
        self.frame_4 = QtWidgets.QFrame(self.centralwidget)
        self.frame_4.setGeometry(QtCore.QRect(480, 530, 451, 351))
        ...
        self.frame_3.setGeometry(QtCore.QRect(10, 530, 451, 351))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.combo_Selection.setItemText(3, _translate("MainWindow", "Tag Test"))
        ...
        self.label_9.setText(_translate("MainWindow", "Leistung Reader in dBm"))
        ...
        self.checkBox_3.setText(_translate("MainWindow", "einzelnes Board "))
